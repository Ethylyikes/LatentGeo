...
class FSDPVLLMShardingManager(BaseShardingManager):
    ...
    def _make_weight_iterator(
        ...
        def _normalize(name: str) -> str:
            # HF transformers>=4.56 prefixes Qwen2.5-VL weights with "model.visual" / "model.language_model".
            # vLLM still expects the legacy layout without that extra nesting.
        ...
        for name, tensor in actor_weights.items():
            ...
            yield norm_name, tensor.full_tensor() if self.world_size != 1 else tensor
